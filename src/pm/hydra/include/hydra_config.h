...
#define HYDRA_AVAILABLE_LAUNCHERS "ssh rsh fork slurm ll lsf sge pbs manual persist"
...
/* Configure arguments */
#define HYDRA_CONFIGURE_ARGS_CLEAN "'--disable-option-checking' '--prefix=/home/mahdieh/project/mahdieh/mvapich_nbrhood11/build' '--cache-file=/dev/null' '--srcdir=.' 'CC=gcc' 'CFLAGS= -DNDEBUG -DNVALGRIND -O2' 'LDFLAGS=-L/lib -L/lib -L/lib -Wl,-rpath,/lib -L/lib -Wl,-rpath,/lib -L/lib -L/lib' 'LIBS=-libmad -lrdmacm -libumad -libverbs -ldl -lrt -lm -lpthread ' 'CPPFLAGS= -I/home/mahdieh/project/mahdieh/mvapich_nbrhood11/mvapich2-2.2/src/mpl/include -I/home/mahdieh/project/mahdieh/mvapich_nbrhood11/mvapich2-2.2/src/mpl/include -I/home/mahdieh/project/mahdieh/mvapich_nbrhood11/mvapich2-2.2/src/openpa/src -I/home/mahdieh/project/mahdieh/mvapich_nbrhood11/mvapich2-2.2/src/openpa/src -D_REENTRANT -I/home/mahdieh/project/mahdieh/mvapich_nbrhood11/mvapich2-2.2/src/mpi/romio/include -I/include -I/include -I/include -I/include'"
...
#define HYDRA_RELEASE_DATE "Wed Sep  7 14:33:43 EDT 2016"

/* Hydra version information */
#define HYDRA_VERSION "3.1.4"
...
#define PACKAGE_STRING "Hydra 3.1.4"
